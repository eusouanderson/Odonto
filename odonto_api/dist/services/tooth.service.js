...
let ToothService = class ToothService {
    constructor(toothModel) {
        this.toothModel = toothModel;
    }
    async create(createToothDto) {
...
exports.ToothService = ToothService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, mongoose_1.InjectModel)(tooth_schema_1.Tooth.name)),
